...
namespace Calculadora
{
    static class Program
    {
        ...
        private static VBO<Vector3> triangle, square, circle;
        private static VBO<int> triangleElements, squareElements, circleElements;
        /// <summary>
        ...
        static void Main()
        {
            ...
            Glut.glutCreateWindow("Progra IV");
            ...
            // create a triangle
            circle = new VBO<Vector3>(new Vector3[] { new Vector3(2, 3, 1), new Vector3(1, -1, 0), new Vector3(1, -1, 0) });
            circleElements = new VBO<int>(new int[] { 0, 1, 2 }, BufferTarget.ElementArrayBuffer);
